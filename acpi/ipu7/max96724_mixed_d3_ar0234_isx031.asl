 ...
 *
 * Channel-level defines (set per CHxx):
...
DefinitionBlock ("", "SSDT", 2, "", "IMG_IPU", 0x20260904)
{
    ...
    Scope (\_SB.PC00)
    {
        Device (DES0)
        {
            ...
            // Channel-level defines for Channel 0 (D3 AR0234)
            ...
            // Channel-level defines for Channel 1 (D3 AR0234)
            ...
            // Channel-level defines for Channel 2 (D3 ISX031)
            ...
            // Channel-level defines for Channel 3 (D3 ISX031)
        ...
        Device (DES1)
        {
            ...
            // Channel-level defines for Channel 0 (D3 ISX031)
            #define DESCH_LINK_NUM 0
            #define DESCH_CH CH00
            #define DESCH_SER SER0
            #define DESCH_CAM CAM0
            ...
            // Channel-level defines for Channel 1 (D3 ISX031)
            #define DESCH_LINK_NUM 1
            #define DESCH_CH CH01
            #define DESCH_SER SER1
            #define DESCH_CAM CAM1
            ...
            // Channel-level defines for Channel 2 (D3 AR0234)
            #define DESCH_LINK_NUM 2
            #define DESCH_CH CH02
            #define DESCH_SER SER2
            #define DESCH_CAM CAM2
            ...
            // Channel-level defines for Channel 3 (D3 AR0234)
            #define DESCH_LINK_NUM 3
            #define DESCH_CH CH03
            #define DESCH_SER SER3
            #define DESCH_CAM CAM3

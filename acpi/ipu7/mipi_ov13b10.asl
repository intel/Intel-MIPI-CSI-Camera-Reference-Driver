 ...
 *
 * SSDT overlay: Direct MIPI CSI-2 OV13B10 camera configuration on PTL platform.
 *
 ...
 *
 * Default configuration (from BIOS table for OV13B10 on IPU75XA):
 *   CAM0: I2C1, MIPI port 0, 4 lanes, RESET COM1 C_D_E_H pad 10 (GPI1 pin 27),
 *         POWER_EN COM0 C_D_E_H pad 5 (GPI0 pin 29)
 *   CAM1: I2C2, MIPI port 2, 2 lanes, RESET COM1 C_D_E_H pad 1 (GPI1 pin 36),
 *         POWER_EN COM0 C_D_E_H pad 8 (GPI0 pin 32)
 */
...
DefinitionBlock ("", "SSDT", 2, "", "IMG_IPU", 0x20260827)
{
    ...
    Scope (\_SB.PC00)
    {
        Device (CAM0)
        {
            ...
            #define CAM_RESET_PIN 27        // COM1 C_D_E_H pad 10
            #define CAM_POWER_PIN 29        // COM0 C_D_E_H pad 5 (Power_En)
            // Use POWER_EN GPIO resource for probe-time toggling.
            #define CAM_RESET_GPIORSC 1
            // Logical low maps to physical high (enable rail).
        ...
        Device (CAM1)
        {
            #define CAM_I2C_BUS "\\_SB.PC00.I2C2"
            #define CAM_I2C_ADDR 0x0010
            #define CAM_TO_MIPI_PORT 2
            #define CAM_LANES 2
            #define CAM_RESET_GPIO_CTLR "\\_SB.GPI1"
            #define CAM_POWER_GPIO_CTLR "\\_SB.GPI0"
            #define CAM_RESET_PIN 36        // COM1 C_D_E_H pad 1
            #define CAM_POWER_PIN 32        // COM0 C_D_E_H pad 8 (Power_En)
            // Use POWER_EN GPIO resource for probe-time toggling.
            #define CAM_RESET_GPIORSC 1
            // Logical low maps to physical high (enable rail).
            #define CAM_RESET_ACTIVE_LOW 1

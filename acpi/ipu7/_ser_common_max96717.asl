...
Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
{
    ...
    CSI2Bus(
        ...
        1,                      // LocalPort (MAX96717 only 1 PHY)
    ...
    {
#ifdef DESCH_SER_RESET_GPIO
        DESCH_SER_RESET_GPIO,   // Pin 0 (e.g. MFP0 on MAX96717)
#endif
#ifdef DESCH_SER_FSIN_GPIO
        DESCH_SER_FSIN_GPIO,   // Extra pin (e.g. MFP7 on MAX96717)
#endif
#ifdef DESCH_SER_FSIN_GPIO_2
        DESCH_SER_FSIN_GPIO_2,   // Extra pin (e.g. MFP7 on MAX96717)
#endif
    }
})

 ...
 *
 * SSDT overlay: Direct MIPI CSI-2 ISX031 camera configuration on PTL platform.
 *
 ...
 *   CAM_RESET_PIN     - GPIO pin number for RESET (e.g. 27 for GPP_E_1)
...
DefinitionBlock ("", "SSDT", 2, "", "IMG_IPU", 0x20260807)
{
    ...
    External (_SB.GPI1, DeviceObj)          // GPIO controller for RESET

 ...
 *
 * SSDT overlay: 3x Sensing M3A GMSL camera + 1x RS D457 configuration on Robinson Bay.
 *
 *   DES0 (MAX96724 2-trio CPHY, MIPI port 0)
 *     - Link 1: 4-lane Sensing M3A            (MAX96717 SER @ 0x40)
 *     - Link 2: 4-lane Sensing M3A            (MAX96717 SER @ 0x40)
 *     - Link 3: 4-lane Sensing M3A            (MAX96717 SER @ 0x40)
 *   DES1 (MAX96724 2-trio CPHY, MIPI port 2)
 *     - Link 1: 2-lane RealSense D457         (MAX9295A SER @ 0x40, D457 VC mapping)
 *
 ...
 *
 * 3x Sensing M3A on MIPI-0 (90, 180, 270),   --> DES0, channel 1,2,3 : frame sync enabled
 * 1x RealSense on MIPI-2 (90)                --> DES1, channel 1     : frame sync enabled
 *
 */


DefinitionBlock ("", "SSDT", 2, "", "IMG_ROB", 0x20260916)
{
    ...
    Scope (\_SB.PC00)
    {
        Device (DES0)
        {
            ...
            // Channel 1/acpi 2 (Sensing M3A MFP7 fsync)
            ...
            #define CAM_LANES 4
            #include "_des_ch_common_m3a.asl"
            #undef DESCH_CH
            #undef DESCH_SER
            #undef DESCH_CAM
            #undef DESCH_CH_PATH
            ...
            // Channel 2/acpi 3 (Sensing M3A MFP7 fsync)
            ...
            // Channel 3/acpi 4 (Sensing M3A MFP7 fsync)

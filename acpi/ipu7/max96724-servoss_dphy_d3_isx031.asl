 ...
 *
 * SSDT overlay: D3 ISX031 GMSL camera configuration on PTL platform (DPHY variant)
 *   Two MAX96724 deserializers with DPHY connection to PTL platform:
 *     - DES0: four D3 ISX031 cameras over GMSL Links 0..3, connected to SOC via 4-lane DPHY
 *     - DES1: two  D3 ISX031 cameras over GMSL Links 0..1, connected to SOC via 2-lane DPHY

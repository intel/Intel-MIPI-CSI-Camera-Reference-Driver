 ...
 *
 * Description: Common template for a direct MIPI CSI-2 ISX031 camera device.
 ...
 *   CAM_I2C_ADDR      - Camera I2C slave address (e.g. 0x001A)
...
Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
{
    ...
    GpioIo (
        ...
        CAM_GPIO_CTLR,          // ResourceSource (GPIO controller)
...
Name (_DSD, Package ()           // _DSD: Device-Specific Data
{
    ...
    Package ()
    {
        ...
        /*
         * reset-gpios: used by isx031.c driver via
         * devm_gpiod_get_optional(dev, "reset", ...)
         * Format: { <gpio_ref>, <resource_index>, <pin_index>, <active_low> }
         */
        Package () { "reset-gpios", Package () { CAM_GPIO_REF, 0, 0, 1 } },
    },

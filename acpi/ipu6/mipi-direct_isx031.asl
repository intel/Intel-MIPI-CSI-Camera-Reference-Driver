 ...
 *
 * SSDT overlay: Direct MIPI CSI-2 ISX031 camera configuration on MTL platform.
 *
 ...
 *   CAM_TO_MIPI_PORT  - Connected IPU0 MIPI port (e.g. 0/1/2/3/4/5)
 *   CAM_LANES         - Number of MIPI data lanes (e.g. 2, 4)
 *   CAM_GPIO_CTLR     - GPIO controller path (e.g. "\\_SB.GPI0")
...
DefinitionBlock ("", "SSDT", 2, "", "IMG_IPU", 0x20260807)
{
    ...
    External (_SB.GPI0, DeviceObj)          // GPIO controller COM0 for CAM0 RESET
    External (_SB.GPI3, DeviceObj)          // GPIO controller COM3 for CAM1 RESET
    ...
    Scope (\_SB.PC00)
    {
        Device (CAM0)
        {
            ...
            #define CAM_LANES 4
            #define CAM_GPIO_CTLR "\\_SB.GPI0"
            #define CAM_RESET_PIN 48        // GPP_D_23 (COM0: vGPIO_3 0-24, GPP_D starts at 25)
        ...
        Device (CAM1)
        {
            ...
            #define CAM_I2C_ADDR 0x001A
            #define CAM_TO_MIPI_PORT 4
            #define CAM_LANES 4
            #define CAM_GPIO_CTLR "\\_SB.GPI3"
            #define CAM_RESET_PIN 0         // GPP_H_0 (COM3: GPP_H starts at 0)
            #define CAM_IPU_PATH "\\_SB.PC00.IPU0"
            #define CAM_IPU_REF \_SB.PC00.IPU0

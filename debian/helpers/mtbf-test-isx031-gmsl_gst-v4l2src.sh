...
reg_max9x_lnklock () {
	...
	REGS=("0x001A:3/LNKA_LOCKED" "0x000A:3/LNKB_LOCKED")
    else
	REGS=("0x001A:3/LNKA_LOCKED" "0x000A:3/LNKB_LOCKED" "0x000B:3/LNKC_LOCKED" "0x000C:3/LNKD_LOCKED" \
				     "0x0108:6/VIDA_LOCK" "0x011A:6/VIDB_LOCK" "0x012C:6/VIDC_LOCK" "0x013E:6/VIDD_LOCK")
    fi
    for REG in "${REGS[@]}"; do
        ADDR=${REG%:*}
        ARGS=${REG#*:}
...
reg_max9x_vidlock () {
    ...
    # Mapping: RegAddr:Bit
    DEEP_REGS=("0x0108:5/VIDA_PKT_DET" "0x011A:5/VIDB_PKT_DET" "0x012C:5/VIDC_PKT_DET" "0x013E:5/VIDD_PKT_DET")
...
reg_max9x_deserr () {
    ...
    # Mapping: RegAddr:Bit
    if [[ $DNAME == "max9296" ]]; then
	REGS=("0x01dc:5/VPRBS_FAIL" "0x01fc:5/VPRBS_FAIL"\
				    "0x0100:0/VIDA_LCRC_ERR" "0x0112:4/VIDB_LCRC_ERR" "0x0124:0/VIDC_LCRC_ERR" "0x0136:0/VIDD_LCRC_ERR")
    else
	REGS=("0x01dc:5/VPRBS_FAIL" "0x01fc:5/VPRBS_FAIL" \
				    "0x0108:4/VIDA_SEQ_ERR" "0x011A:4/VIDB_SEQ_ERR" "0x012C:4/VIDC_SEQ_ERR" "0x013E:4/VIDD_SEQ_ERR" \
				    "0x0B1B:2/VIDA_LCRC_ERR" "0x0C1B:2/VIDB_LCRC_ERR" "0x0D1B:2/VIDC_LCRC_ERR" "0x0E1B:2/VIDD_LCRC_ERR")
    fi
	...
	DEEP_REGS=("0x0035:0-FF/DEC_ERR_A" "0x0036:0-FF/DEC_ERR_B" "0x0037:0-FF/DEC_ERR_C" "0x0038:0-FF/DEC_ERR_D" \
					   ...
					   "0x0B19:0-FF/CC_CRC_ERR_A" "0x0C19:0-FF/CC_CRC_ERR_B" "0x0D19:0-FF/CC_CRC_ERR_C" "0x0E19:0-FF/CC_CRC_ERR_D" \
					   "0x0B1A:0-FF/RC_CRC_ERR_A" "0x0C1A:0-FF/RC_CRC_ERR_B" "0x0D1A:0-FF/RC_CRC_ERR_C" "0x0E1A:0-FF/RC_CRC_ERR_D" \
					   "0x0B1C:0-3F/EOM_EYE_WIDTH_A" "0x0C1C:0-3F/EOM_EYE_WIDTH_B" "0x0D1C:0-3F/EOM_EYE_WIDTH_C" "0x0E1C:0-3F/EOM_EYE_WIDTH_D" \

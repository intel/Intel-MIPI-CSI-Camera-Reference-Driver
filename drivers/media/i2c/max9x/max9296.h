...
#define MAX9296_PHY_REM_CTRL_B (0x4)
#define MAX9296_PHY_REM_CTRL_B_RX_FIELD GENMASK(1, 0)
#define MAX9296_GMSL1_EN 0xF00
#define MAX9296_GMSL1_EN_LINK_EN_FIELD GENMASK(1, 0)
...
#define MAX9296_MIPI_TX_DESKEW_PERIODIC(csi) (MAX9296_MIPI_TX(csi) + 0x04)
#define MAX9296_MIPI_TX_DESKEW_PERIODIC_EN BIT(7)
#define MAX9296_MIPI_TX_DESKEW_PERIODIC_INTERVAL_FIELD GENMASK(5, 3)
#define MAX9296_MIPI_TX_DESKEW_PERIODIC_WIDTH_FIELD GENMASK(2, 0)
